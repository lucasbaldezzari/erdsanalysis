...
eeg_concatenados = concatenateEEGs(sujeto, sesion, apply_ica=True).pick(pick,"ignore")
...
eeg_concatenados.filter(l_freq=5, h_freq=None,
           picks='eeg', 
           method='fir', 
           phase='zero-double', 
           fir_window='hamming',
...
#1. Calcular curvas ERDS% para cada clase y para algunos canales de interés sobre
...
# También se podría usar Hilbert para esto.
