...
erds_izq = getHilbertERDS(clase_izquierda, baseline, apply_smooth=True, window_smoothing=51)
erds_der = getHilbertERDS(clase_derecha, baseline, apply_smooth=True, window_smoothing=51)
...
tfr_der_wbaseline.average().plot_joint(picks="C3",
    baseline=(-2, -0.5), mode="percent", tmin=-2, tmax=3,cnorm = cnorm, cmap = cmap, topomap_args = {"cnorm":cnorm},
...
tfr_izq_wbaseline.average().plot_joint(picks="C4",
    baseline=(-1.5, -0.5), mode="percent", tmin=-2, tmax=3,cnorm = cnorm, cmap = cmap, topomap_args = {"cnorm":cnorm},
    timefreqs=[(-0.5, 10), (-0.5, 12),(0.5, 10), (0.5, 12),(2, 10), (2, 12)])
tfr_izq_wbaseline.average().plot_joint(picks="C4",
    baseline=(-1.5, -0.5), mode="percent", tmin=-2, tmax=3, cnorm = cnorm, cmap = cmap, topomap_args = {"cnorm":cnorm},
    timefreqs=[(-1.5,12),(-0.5, 12),(0,12),(1,12),(1.5,12)])
tfr_izq_wbaseline.average().plot_joint(picks="C4",
    baseline=(-1.5, -0.5), mode="percent", tmin=-2, tmax=3, cnorm = cnorm, cmap = cmap, topomap_args = {"cnorm":cnorm},
    timefreqs=[(-1.5,25),(-0.5, 25),(0,25),(1,25),(1.5,25)])
